...
public:
  ...
  inline ntlVector3Dim(DirectX::XMVECTOR &v );
  ...
  inline void safeDivide (const ntlVector3Dim<Scalar>& v);
...
template<class Scalar>
inline ntlVector3Dim<Scalar>::ntlVector3Dim( DirectX::XMVECTOR &v )
{
...
template<class Scalar>
inline void ntlVector3Dim<Scalar>::safeDivide( const ntlVector3Dim<Scalar> &v )
{
...
template<class Scalar>
inline ntlVector3Dim<Scalar> 
operator+(float s, ntlVector3Dim<Scalar> v) 
{
  return v + s;
}
...
template<class Scalar>
inline ntlVector3Dim<Scalar> 
operator+(double s, ntlVector3Dim<Scalar> v) 
{
  return v + s;
}
...
template<class Scalar>
inline ntlVector3Dim<Scalar> 
operator+(int s, ntlVector3Dim<Scalar> v) 
{
  return v + s;
}
...
/*************************************************************************
  ...
  */
template<class Scalar>
inline Scalar norm( const ntlVector3Dim<Scalar> &v)
{
 ...
 */
template<class Scalar>
inline Scalar normNoSqrt( const ntlVector3Dim<Scalar> &v) {
...
/*************************************************************************
  ...
  */
template<class Scalar>
inline ntlVector3Dim<Scalar> getNormalized( const ntlVector3Dim<Scalar> &v)
{
	Scalar l = v[0]*v[0] + v[1]*v[1] + v[2]*v[2];
	...
	{
		Scalar fac = 1./sqrt(l);
		return ntlVector3Dim<Scalar>(v[0]*fac, v[1]*fac, v[2]*fac);
	}
	else
 ...
 */
	template<class Scalar>
inline Scalar normalize( ntlVector3Dim<Scalar> &v) 
{
	Scalar norm;
	Scalar l = v[0]*v[0] + v[1]*v[1] + v[2]*v[2];  
	if (fabs(l-1.) < VECTOR_EPSILON*VECTOR_EPSILON) {
 ...
 */
	template<class Scalar>
inline void vecToAngle(const ntlVector3Dim<Scalar> &v, Scalar& phi, Scalar& theta) 
{
...
/*************************************************************************
  ...
  */
template<class Scalar>
inline ntlVector3Dim<Scalar> reflectVector(const ntlVector3Dim<Scalar> &t, const ntlVector3Dim<Scalar> &n) 
{
  ntlVector3Dim<Scalar> nn= (dot(t, n) > 0.0) ? (n*-1.0) : n;
 ...
 */
template<class Scalar>
inline ntlVector3Dim<Scalar> refractVector(const ntlVector3Dim<Scalar> &t, const ntlVector3Dim<Scalar> &normal, Scalar nt, Scalar nair, int &refRefl) 
{
	Scalar eta = nair / nt;
...
/*************************************************************************
  ...
  */
template<class Scalar>
inline bool equal(const ntlVector3Dim<Scalar> &v, const ntlVector3Dim<Scalar> &c)
{
  return (ABS(v[0]-c[0]) + 
	  ABS(v[1]-c[1]) + 
 ...
 */
template<class Scalar>
inline void rgbToHsv( ntlVector3Dim<Scalar> &V )
{
	Scalar h=0,s=0,v=0;
 ...
 */
template<class Scalar>
inline void hsvToRgb( ntlVector3Dim<Scalar> &V )
{
...
template<class Scalar>
std::ostream&
operator<<( std::ostream& os, const GamePhysics::ntlVector3Dim<Scalar>& i )
{
...
template<class Scalar>
std::istream&
operator>>( std::istream& is, GamePhysics::ntlVector3Dim<Scalar>& i )
{
	char c;
	char dummy[3];
